...
data_path=/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/raw_data_transposon2/20250220_LLX_CUTTag/
# antibodys=(ATAC ATAC H3K36me3 H3K27me3 H3K36me3 H3K27me3)
...
# samples=$(find ${data_path}bigWig -type f -name "*.nodup.bw" -exec basename {} \; | sed 's/_.*//'  | sort) 
...
antibodys=(ATAC ATAC H3K9me3 H3K36me3 H3K27me3 H3K9me3 H3K36me3 H3K27me3)
...
data_path=/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/raw_data/20240426_SZJ/
