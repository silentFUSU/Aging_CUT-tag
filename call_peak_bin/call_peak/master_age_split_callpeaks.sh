...
do  
    ...
    # bash /storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/code/call_peak/macs2_age_split_bam_callpeaks.sh $tissue 2>&1>~/projects/Aging_CUT_Tag/logs/${tissue}_ATAC_macs2_age_split_bam_callpeaks.log &
    ...
    echo $tissue macs2 begin
    bash /storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/code/call_peak/call_peak/ATAC_macs2_age_split_bam_callpeaks.sh $tissue 2>&1>~/projects/Aging_CUT_Tag/logs/${tissue}_ATAC_macs2_age_split_bam_callpeaks.log &
