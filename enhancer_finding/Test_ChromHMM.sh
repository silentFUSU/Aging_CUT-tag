...
do
    ...
    # java -Xmx16G -jar ${ChromHMM_path}ChromHMM.jar LearnModel -b 1000 -p 16 -holdcolumnorder ${data_path}all/combined_analysis_enhancer/binarizedData ${result_path}all/ChromHMM/${state} ${state} ${ref}
