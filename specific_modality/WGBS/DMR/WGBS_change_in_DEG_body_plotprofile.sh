...
/usr/local/lib64/R/bin/Rscript ~/projects/Aging_CUT_Tag/code/WGBS/DMR/WGBS_DEG_genebody_make.R ${tissue}
...
do
    ...
    computeMatrix scale-regions -S $young1_bw $young2_bw $old1_bw $old2_bw -R $bed \
        ...
        --skipZeros -o ${result_path}WGBS_change_in_DEG/matrix/WGBS_change_in_DEG_body_${condition}.mat.gz

    plotProfile -m ${result_path}WGBS_change_in_DEG/matrix/WGBS_change_in_DEG_body_${condition}.mat.gz \
        ...
        --perGroup \
        -out ${result_path}WGBS_change_in_DEG/plot/WGBS_change_in_DEG_body_${condition}.pdf

    /usr/local/lib64/R/bin/Rscript ~/projects/Aging_CUT_Tag/code/WGBS/DMR/WGBS_change_in_DEG_body_plotprofile.R ${tissue} ${condition} &
