...
ggsave("result/WGBS/all_tissues_top_motif_snapatact2_mutual_bg.png",combined_plot,width = 70,height = 35,limitsize = FALSE)
combined_plot <- plot_a_list(p_list_tissue_order[c(1:14)],no_of_rows = 3,no_of_cols = 5)
ggsave("result/WGBS/all_tissues_top_motif_snapatact2_mutual_bg_1_14.png",combined_plot,width = 50,height = 25,limitsize = FALSE)
combined_plot <- plot_a_list(p_list_tissue_order[c(15:27)],no_of_rows = 3,no_of_cols = 5)
ggsave("result/WGBS/all_tissues_top_motif_snapatact2_mutual_bg_15_27.png",combined_plot,width = 50,height = 25,limitsize = FALSE)
