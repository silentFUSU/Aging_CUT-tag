...
tissue_order <- c("Mammary Gland","Kidney","Skin","Pancreas","Heart","Ileum","Liver","Stomach","Cecum","Muscle",
                  "Bone Marrow","Colon","Spleen","Cortex","Lung","Thymus","Cerebellum","Hippocampus")

to_plot <- to_plot[tissue_order,]
pheatmap::pheatmap(to_plot,breaks = breaks,border_color = "black", color = color_palette,cluster_cols = F,filename = paste0("result/Sup_figures/HiC_",antibody,"_domain_interaction.pdf"),width = 6,height = 8,cluster_rows = F,main = antibody)
