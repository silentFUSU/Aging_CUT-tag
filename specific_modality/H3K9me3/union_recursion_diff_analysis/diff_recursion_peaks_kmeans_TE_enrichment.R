...
# }), ]
p <- pheatmap::pheatmap(to_plot,main = paste0(Classification," TE length percentage"),color = color_palette,annotation_colors = list(class_id=color),scale = "row",cluster_cols = F,filename = "result/Sup_figures/H3K9me3_family_TE_heatmap.pdf",width = 8,height = 10,annotation_row = annotation)
...
ggsave("result/Sup_figures/H3K9me3_family_TE_barplot.pdf",combined_plot,width = 10,height = 10)
