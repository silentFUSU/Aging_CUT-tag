...
ggsave("result/Sup_figures/all_tissue_H3K27me3_H3K9me3_after_remove_batch_effect.png",combined_plot,width = 35,height = 20,type="cairo")

# ggsave("result/Sup_figures/all_tissue_H3K27me3_H3K9me3_after_remove_batch_effect.pdf",combined_plot,width = 35,height = 20)
