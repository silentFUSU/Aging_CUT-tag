...
do
    ...
    python /storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/code/ATAC/summary_figure_test/snapatac2_motif_enrichment_stable_as_input.py --tissue ${tissue} &
done