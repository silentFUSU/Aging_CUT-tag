...
do
    ...
    python /storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/code/ATAC/summary_figure_test/snapatac2_motif_enrichment_common_peak_set.py --tissue ${tissue} &
done