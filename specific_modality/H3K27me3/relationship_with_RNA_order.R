...
color <- setNames(c("#f39b7f","#4dbbd5"),c("fourth","second"))
p <- ggplot(percentage_summary, aes(x = variable, y = percentage, fill = condition,color=condition)) +  
  ...
  scale_color_manual(values = c("second" = "black", "fourth" = "white")) 
ggsave("result/figures/H3K27me3_RNA_percentage_in_young_peak.pdf",p,width = 12,height = 6)  
