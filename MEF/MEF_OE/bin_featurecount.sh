...
do
    ...
    do
        ...
        featureCounts -p -a /storage/zhangyanxiaoLab/suzhuojie/ref_data/mm10_10kb_bins.saf -o ${data_path}${antibody}/${antibody}_MEF_Vector_${condition}_10kb.counts ${files[@]} -F SAF -T 8 
    done
done

for antibody in ${antibodys[@]}
do
    files=$(ls ${data_path}${antibody}/*/bam/*.bam)
    featureCounts -p -a /storage/zhangyanxiaoLab/suzhuojie/ref_data/mm10_10kb_bins.saf -o ${data_path}${antibody}/${antibody}_all_10kb.counts ${files[@]} -F SAF -T 8 
done