...
for(antibody in antibodys){
  ...
  for(condition in conditions){
    # peaks <- read.table(paste0("data/samples/MEF_OE/",antibody,"/MEF_Vector/bed/",antibody,"_MEF_Vector_merge-W5000-G10000-E100.bed"))
    ...
    diff <- read.csv(paste0("data/samples/MEF_OE/",antibody,"/",condition,"/",antibody,"_",condition,"_10kb_bins_diff_after_remove_batch_effect.csv"))
