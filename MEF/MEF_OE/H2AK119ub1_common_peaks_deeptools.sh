...
gap_size=10000
e_value=100
mkdir -p ${result_path}matrix_119ub1_spike_in/
mkdir -p ${result_path}plot_119ub1_spike_in/
...
do
    ...
    do
        ...
        do
            file=$(ls ${data_path}${antibody}/MEF_Vector/bw/${sample}.scaled.filt.srt.bw)
            files+=("$file")
        done
        ...
        for sample in ${sample_array[@]}
        do
            file=$(ls ${data_path}${antibody}/${condition}/bw/${sample}.scaled.filt.srt.bw)
            files+=("$file")
        done
        peak=/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/samples/MEF_OE/H2AK119ub1/common_peaks.bed
        ...
        computeMatrix scale-regions -S ${files[@]} -R $peak \
            ...
            --skipZeros -o ${result_path}matrix_119ub1_spike_in/${antibody}_${condition}_p2_peaks.mat.gz
        
        plotProfile -m ${result_path}matrix_119ub1_spike_in/${antibody}_${condition}_p2_peaks.mat.gz \
            ...
            -out ${result_path}plot_119ub1_spike_in/${antibody}_${condition}_p2_peaks.pdf 
    done
done