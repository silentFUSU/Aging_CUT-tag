...
for(antibody in antibodys){
  for(condition in conditions){
    ...
    write.csv(out,paste0("data/samples/MEF_OE/",antibody,"/",condition,"/",antibody,"_",condition,"_peaks_diff_after_remove_batch_effect.csv"),row.names = F)
...
combined_p
ggsave("result/MEF_OE/all_diff_peak.png",combined_p,width=15,height=10)
