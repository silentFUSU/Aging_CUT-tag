...
do
    ...
    echo ${tissue} begin
    bash ${code_path}H3K27me3_call_age_domain_edd.sh $tissue 2>&1>>/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/logs/${tissue}_H3K27me3_call_age_domain_edd.log &
done
wait
