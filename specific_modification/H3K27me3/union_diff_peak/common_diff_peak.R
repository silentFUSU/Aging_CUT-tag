...
common_diff_peak <- function(antibody,tissues){
  ...
  for (i in c(1:length(tissues))){
    tissue <- tissues[i]
    df <- read.csv(paste0("data/samples/",tissue,"/",antibody,"/",antibody,"_young_merge-W5000-G10000-E100_peak_merged_exist_in_all_tissues.csv")) 
  ...
  peak_file <- read.table(paste0("data/samples/all/",antibody,"/bed/",antibody,"_young_merge-W5000-G10000-E100_peak_merged_exist_in_all_tissues.bed"))
  ...
  write.csv(increase_count,paste0("data/samples/all/",antibody,"/common_increase_young_merge-W5000-G10000-E100_peak_merged_exist_in_all_tissues_after_remove_batch_effect.csv"),row.names = F)
  write.csv(decrease_count,paste0("data/samples/all/",antibody,"/common_decrease_young_merge-W5000-G10000-E100_peak_merged_exist_in_all_tissues_after_remove_batch_effect.csv"),row.names = F)
