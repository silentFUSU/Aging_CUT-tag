...
tissue <- "lung"
state_num <- "11"
kmeans_df <- read.csv("data/samples/all/H3K9me3/recursion_peaks_diff_table/kmeans_annotation.csv")
...
for(kmean in c(1:4)){
  ...
  p<-ggplot(to_plot, aes(x = variable, y = value, fill = Var1)) +  
    ...
    ylab("Proportion")
  ggsave(paste0("result/all/diff/H3K9me3/recursion_peaks_kmeans/chromHMM/kmeans",kmean,"_chromHMM_annotation_young.png"),p,width = 20,height = 10,type="cairo")
}
...
for(kmean in c(1:4)){
  ...
  p<-ggplot(to_plot, aes(x = variable, y = value, fill = Var1)) +  
    ...
    theme(axis.title.x = element_blank(), 
          ...
          text = element_text(size = 20),legend.title = element_blank()) +
    ylab("Proportion")
  ggsave(paste0("result/all/diff/H3K9me3/recursion_peaks_kmeans/chromHMM/kmeans",kmean,"_chromHMM_annotation_old.png"),p,width = 20,height = 10,type="cairo")
}
