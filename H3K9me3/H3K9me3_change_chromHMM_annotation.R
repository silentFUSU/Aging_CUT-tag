...
tissue <- "CB"
state_num <- "14"
H3K9me3_change_region_chromHMM_annotation <- function(tissue,state_num){
  ...
  for(condition in conditions){
    H3K9me3_condition <- H3K9me3[which(H3K9me3$Significant==condition),c("Chr","Start","End")]
    H3K9me3_condition$Start <- H3K9me3_condition$Start+1
    H3K9me3_condition <- as.data.table(H3K9me3_condition)
    setDT(H3K9me3_condition)  
    setkey(H3K9me3_condition, Chr, Start, End) 
    
    overlaps_young <- foverlaps(H3K9me3_condition, chromHMM_young, type = "any", nomatch = 0L)  
    overlaps_old <- foverlaps(H3K9me3_condition, chromHMM_old, type = "any", nomatch = 0L)  
...
for(tissue in tissues){
  p_list <- H3K9me3_change_region_chromHMM_annotation(tissue,state_num)
...
ggsave(paste0("result/all/diff/H3K9me3/H3K9me3_increase_chromHMM_annotation.png"),increase_combined_plot,height = 20,width = 30,type="cairo")
ggsave(paste0("result/all/diff/H3K9me3/H3K9me3_decrease_chromHMM_annotation.png"),decrease_combined_plot,height = 20,width = 30,type="cairo")
