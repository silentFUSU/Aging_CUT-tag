...
for(tissue in tissues){
  ...
  peaks <- read.table(paste0("data/samples/",tissue,"/H3K9me3/bed/H3K9me3_10kb_in_young_old_merge-W5000-G10000-E100_bedtools_filtered.bed"))
...
common_increase <- read.csv("data/samples/all/H3K9me3/common_increase_10kb_bins_after_remove_batch_effect.csv")
common_decrease <- read.csv("data/samples/all/H3K9me3/common_decrease_10kb_bins_after_remove_batch_effect.csv")
peaks <- read.table(paste0("data/samples/lung/H3K9me3/bed/H3K9me3_10kb_in_young_old_merge-W5000-G10000-E100_bedtools_filtered.bed"))
common_increase_region <- common_increase$Geneid[which(common_increase$n > 5 & common_increase$Geneid %in% peaks$V4)]
common_decrease_region <- common_decrease$Geneid[which(common_decrease$n > 5 & common_decrease$Geneid %in% peaks$V4)]
