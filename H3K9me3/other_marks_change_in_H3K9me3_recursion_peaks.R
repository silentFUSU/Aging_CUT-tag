...
logFC_heatmap_all_tissues <- function(antibody){
  ...
  pheatmap::pheatmap(summary[,-1],breaks = breaks,cluster_cols = F,show_rownames = F,annotation_row=annotation,color = color_palette,cluster_rows = F,main = antibody,legend = F,annotation_legend = F)
}