tissue=lung
data_path=/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/raw_data/20240905_DYQ_001-004_WGBS/
...
young_samples=$(awk -F',' -v t="$tissue"  'NR > 1 && ($1 == t) && ($5 == "3M") {print $3}' "$search_table") 
old_samples=$(awk -F',' -v t="$tissue"  'NR > 1 && ($1 == t) && ($5 == "24M") {print $3}' "$search_table") 
