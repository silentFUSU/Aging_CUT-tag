...
tissues=(brain liver testis colon kidney lung spleen muscle Hip cecum bonemarrow)
...
tissues=(heart thymus stomach skin aorta tongue bladder CB jejunum uterus ovary ileum pancreas)
for tissue in ${tissues[@]}
do  
    echo $tissue
    bash /storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/code/call_peak/macs2_age_split_bam_callpeaks.sh $tissue &
