...
# outfile = '/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/IGV_session/pancreas_all.xml'
...
with open(outfile,'w') as f:
  ...
  f.write('  <Resources>\n')
  ## files 
  for sfile in sorted(glob.glob("bw/*_bs10000.bw")):
    f.write('    <Resource path="'+baseurl+"/" + sfile + '"/>\n')
  # for sfile in sorted(glob.glob("pancreas/H3K27me3/bw/*_bs1000.bw")):
  #   f.write('    <Resource path="'+baseurl+"/" + sfile + '"/>\n')
  f.write('  </Resources>\n')
  f.write('</Session>\n')