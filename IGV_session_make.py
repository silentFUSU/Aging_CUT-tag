...
baseurl = 'http://10.28.0.127/share/suzhuojie/Aging_CUT_Tag/BAT/'
outfile = '/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/IGV_session/BAT.xml'
...
with open(outfile,'w') as f:
  ...
  f.write('  <Resources>\n')
  ## files 
  for sfile in sorted(glob.glob("*/bw/*nodup.bw")):
    f.write('    <Resource path="'+baseurl+"/" + sfile + '"/>\n')
  # for sfile in sorted(glob.glob("*/H3K9me3/bw/*bs1000.bw")):
  #   f.write('    <Resource path="'+baseurl+"/" + sfile + '"/>\n')
