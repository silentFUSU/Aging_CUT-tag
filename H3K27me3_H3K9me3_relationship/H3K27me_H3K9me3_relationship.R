...
for(i in c(1:length(tissues))){
  tissue <- tissues[i]
  H3K27me3<-read.csv(paste0("data/samples/",tissue,"/H3K27me3/H3K27me3_",bin_size,"_bins_diff.csv"))
  H3K9me3<-read.csv(paste0("data/samples/",tissue,"/H3K9me3/H3K9me3_",bin_size,"_bins_diff.csv"))
  ...
  write.csv(logFC,paste0("data/samples/all/diff_table/H3K27me3_H3K9me3/",tissue,"_H3K27me3_H3K9me3_10kb_bins_diff.csv"),row.names = F)
...
for(i in c(1:length(tissues))){
  ...
  H3K27me3$H3K9me3_sig[which(H3K27me3$Geneid %in% H3K9me3$Geneid[which(H3K9me3$Significant=="Up")])]<-"H3K9me3_increase"
  H3K27me3$H3K9me3_sig[which(H3K27me3$Geneid %in% H3K9me3$Geneid[which(H3K9me3$Significant=="Down")])]<-"H3K9me3_decrease"
  
  H3K9me3$H3K27me3_sig <- "stable"
  H3K9me3$H3K27me3_sig[which(H3K9me3$Geneid %in% H3K27me3$Geneid[which(H3K27me3$Significant=="Up")])]<-"H3K27me3_increase"
  H3K9me3$H3K27me3_sig[which(H3K9me3$Geneid %in% H3K27me3$Geneid[which(H3K27me3$Significant=="Down")])]<-"H3K27me3_decrease"
