...
result_path = "/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/samples/ATAC/ATAC_peak_from_LMJ/motif_snapatac2_cisbp/motif_bg_stable_input/"
...
regions = read_bed_file(f"/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/samples/ATAC/ATAC_peak_from_LMJ/stable/{tissue}_stable.bed")
conditions=["up","down"]
for condition in conditions:
    background_bed = f"/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/data/samples/ATAC/ATAC_peak_from_LMJ/{condition}/{tissue}_{condition.capitalize()}_sorted.bed"
    ...
    save_enrichment_results(enrichment_results, f"{result_path}stable_vs_{condition}/")
