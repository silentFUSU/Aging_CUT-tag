...
result_path=/storage/zhangyanxiaoLab/suzhuojie/projects/Aging_CUT_Tag/result/all/ChromHMM/until_ovary/15_until_ovary/state_transfer/E9_to_E5/
...
do
    ...
    do
        ...
        do
            ...
            bw=$(ls ${data_path}${tissue}/${antibody}/bw/*nodup.bw | sort | tail -n 2)
            computeMatrix scale-regions -S ${bw} \
                -R ${result_path}/bed/${tissue}.bed \
                --beforeRegionStartLength ${region_length} --startLabel start --endLabel end \
                --regionBodyLength 1000 \
        ...
        /storage/zhangyanxiaoLab/suzhuojie/software/pdfjam-3.11/bin/pdfjam ${result_path}/plot/${tissue}_{H3K27me3,H3K9me3,H3K36me3,H3K27ac,H3K4me1,H3K4me3}_${region_length}*.pdf --nup 6x2  --landscape --outfile ${result_path}/plot/combined_plot/${tissue}_${region_length}.pdf
    done
