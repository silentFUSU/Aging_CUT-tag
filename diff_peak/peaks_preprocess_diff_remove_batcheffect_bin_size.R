...
tissues <- c("brain","liver","testis","kidney","lung","spleen","muscle","pancreas","Hip","bonemarrow","heart","thymus","stomach","skin","aorta","tongue","bladder","CB","jejunum","uterus","ovary","mammarygland")
