...
for(i in c(1:length(tissues))){
  ...
  for(j in c(1:length(antibodys))){
    ...
    write.csv(diff_bin_in_peak,paste0("data/samples/",tissue,"/",antibody,"/",antibody,"_10kb_bins_overlap_young_old_peaks_diff_after_remove_batch_effect.csv"))
  }
}
...
#     antibody<-antibodys[j]
#     diff <- read.csv(paste0("data/samples/",tissue,"/",antibody,"/",antibody,"_10kb_bins_diff_after_remove_batch_effect.csv"))
#     bin_in_peak <- read.table(paste0("data/samples/",tissue,"/",antibody,"/bed/",antibody,"_10kb_in_young-W1000-G3000-E100.bed"))
#     diff_bin_in_peak <- diff[which(diff$Geneid %in% bin_in_peak$V4),]
#     write.csv(diff_bin_in_peak,paste0("data/samples/",tissue,"/",antibody,"/",antibody,"_10kb_bins_overlap_young_peaks_diff_after_remove_batch_effect.csv"))
#     bin_in_peak <- read.table(paste0("data/samples/",tissue,"/",antibody,"/bed/",antibody,"_10kb_in_old_only-W1000-G3000-E100.bed"))
#     diff_bin_in_peak <- diff[which(diff$Geneid %in% bin_in_peak$V4),]
#     write.csv(diff_bin_in_peak,paste0("data/samples/",tissue,"/",antibody,"/",antibody,"_10kb_bins_overlap_old_only_peaks_diff_after_remove_batch_effect.csv"))
#   }
# }
...
for(i in c(1:length(tissues))){
  ...
  for(j in c(1:length(antibodys))){
    ...
    diff_bin_in_peak <- diff[which(diff$Geneid %in% bin_in_peak$V4),]
    write.csv(diff_bin_in_peak,paste0("data/samples/",tissue,"/",antibody,"/",antibody,"_1kb_bins_overlap_young_old_peaks_diff_after_remove_batch_effect.csv"))
  }
}
