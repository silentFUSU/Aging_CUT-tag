...
peak_preprocess_peak_level_remove_batch_effect <- function(tissue,antibody){
  ...
  if(antibody %in% c("H3K27me3","H3K9me3","H3K36me3")){
    tab = read.delim(paste0("data/samples/",tissue,"/",antibody,"/",antibody,"_young_old_merge-W1000-G3000-E100.counts"),skip=1)
  }else{
  ...
  if(antibody %in% c("H3K27me3","H3K9me3","H3K36me3")){
    write.csv(out,paste0("data/samples/",tissue,"/",antibody,"/",antibody,"_young_old_merge-W1000-G3000-E100_diff_after_remove_batch_effect.csv"),row.names = F)
  }else{
