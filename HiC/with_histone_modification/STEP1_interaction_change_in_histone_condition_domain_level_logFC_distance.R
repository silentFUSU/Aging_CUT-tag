...
antibody <- "H3K27me3"
resolution <- 10000
interaction_change_in_histone_condition_domain_level_logFC_distance <- function(tissue,resolution,antibody){
  histone <- read.table(paste0("data/samples/",tissue,"/",antibody,"/peaks/edd/edd_peaks_fdr05.bed"))  
  histone <- histone[,c(1:3)]
  ...
  dir.create(paste0("result/HiC/",tissue,"/with_histone/domain_level/"))
  ggsave(paste0("result/HiC/",tissue,"/with_histone/domain_level/",resolution,"_interaction_relationship_with_",antibody,"_distance.png"),combined_plot,width=10,height = 15,type="cairo")
  ...
  write.csv(summary,paste0("result/HiC/",tissue,"/with_histone/domain_level/",resolution,"_interaction_relationship_with_",antibody,"_distance.csv"))
  ggsave(paste0("result/HiC/",tissue,"/with_histone/domain_level/",resolution,"_interaction_log2Foldchange_relationship_with_",antibody,"_distance.png"),p,width=10,height = 6,type="cairo")
  }



tissues <- c("brain","CB","kidney","liver","bonemarrow","colon","heart","Hip","mammarygland","stomach","thymus","skin","muscle","lung")
antibody <- "H3K27me3"
for(tissue in tissues){
  interaction_change_in_histone_condition_domain_level_logFC_distance(tissue,resolution,antibody)
}
