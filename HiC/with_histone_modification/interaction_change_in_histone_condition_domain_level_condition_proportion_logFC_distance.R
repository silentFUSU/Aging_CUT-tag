...
antibody <- "H3K27me3"
resolution <- "10000"
interaction_change_in_histone_condition_proportion_domain_level_logFC_distance <- function(tissue,resolution,antibody){
  ...
  summary <- read.csv(paste0("result/HiC/",tissue,"/with_histone/domain_level/",resolution,"_interaction_relationship_with_",antibody,"_distance.csv")) 
  ...
  dir.create(paste0("result/HiC/",tissue,"/with_histone/condition_proportion/domain_level/"))
  ggsave(paste0("result/HiC/",tissue,"/with_histone/condition_proportion/domain_level/",resolution,"_interaction_relationship_with_",antibody,"_condition_proportion_distance.png"),combined_plot,width=10,height = 15,type="cairo")
  ...
  ggsave(paste0("result/HiC/",tissue,"/with_histone/condition_proportion/domain_level/",resolution,"_interaction_log2Foldchange_relationship_with_",antibody,"_condition_proportion_distance.png"),p,width=10,height = 6,type="cairo")
  } 
...
for(antibody in antibodys){
  for(tissue in tissues){
    interaction_change_in_histone_condition_proportion_domain_level_logFC_distance(tissue,resolution,antibody)
  }
}
