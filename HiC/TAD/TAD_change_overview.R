...
for(tissue in tissues){
  df <- read.csv(paste0("data/samples/HiC/",tissue,"/TAD/insulation_score/",tissue,"_redundant_20000_TAD_diff_larger_250000.csv"))
...
p <- ggplot(summary, aes(x = percent, y = tissue, fill = Var1)) +
  ...
  labs(x = "Percent", y = "Tissue",fill="condition",title = "TAD") +
...
ggsave("result/figures/TAD_change_percentage.pdf",p,width = 6,height = 10)  
