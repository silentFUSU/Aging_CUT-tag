...
write.csv(redundant_boundary,paste0("data/samples/HiC/all/TAD/all_tissues_",resolution,"_redundant_tads.csv"),row.names = F)
...
write.table(bedpe,paste0("data/samples/HiC/all/TAD/all_tissues_",resolution,"_redundant_tads.bedpe"),append = F,quote = F,sep = "\t",row.names = F,col.names = F)
