...
for(tissue in tissues){
  ...
  if(tissue %in% c("ovary","mammarygland","uterus")){
    H3K9me3_peaks <- H3K9me3_peaks[which(H3K9me3_peaks$chr %in% paste0("chr",c(1:19,"X"))),]
  }
...
H3K9me3_tissue_order <- c("Kidney","Muscle","Skin","Bladder","Stomach","Heart","Hippocampus","Uterus","Liver","Aorta","Testis","Cortex","Tongue","Cerebellum","BAT","Lung","Mammary.Gland",
